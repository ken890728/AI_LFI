                        ...
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <h4 class="text-white">IntelliAssist Pro</h4>
                                    <p class="mb-0 text-white-50">Revolutionize customer interactions with an AI-driven assistant designed to provide instant, accurate responses and seamless user experiences, boosting satisfaction and efficiency.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-black text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    <h4 class="text-white">DataVision Insight</h4>
                                    <p class="mb-0 text-white-50">Turn raw data into actionable insights with this advanced analytics platform, powered by predictive AI models that help you make informed decisions with confidence.</p>
                                </div>
                            </div>
                        </div>
                    </div>
